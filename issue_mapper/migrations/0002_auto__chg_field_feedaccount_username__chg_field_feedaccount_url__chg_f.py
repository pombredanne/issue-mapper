...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeedAccount.username'
        db.alter_column(u'issue_mapper_feedaccount', 'username', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'FeedAccount.url'
        db.alter_column(u'issue_mapper_feedaccount', 'url', self.gf('django.db.models.fields.URLField')(max_length=100, null=True))

        # Changing field 'FeedAccount.password'
        db.alter_column(u'issue_mapper_feedaccount', 'password', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'FeedAccount.username'
        db.alter_column(u'issue_mapper_feedaccount', 'username', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'FeedAccount.url'
        db.alter_column(u'issue_mapper_feedaccount', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=100))

        # Changing field 'FeedAccount.password'
        db.alter_column(u'issue_mapper_feedaccount', 'password', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.6797909980345799'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.9635318608327748'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.1835015136968059'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.7311150969344133'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4a355e2b3267458d9f54d11366bd2ee0'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
