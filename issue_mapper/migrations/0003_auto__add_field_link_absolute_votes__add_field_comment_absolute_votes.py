...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Link.absolute_votes'
        db.add_column(u'issue_mapper_link', 'absolute_votes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Comment.absolute_votes'
        db.add_column(u'issue_mapper_comment', 'absolute_votes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Link.absolute_votes'
        db.delete_column(u'issue_mapper_link', 'absolute_votes')

        # Deleting field 'Comment.absolute_votes'
        db.delete_column(u'issue_mapper_comment', 'absolute_votes')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.2912795077778756'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.492600971953403'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.41047849016701876'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.21553978240309113'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'56930f47c5f64eab9b1197015cfa3ab1'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
