...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'issue_mapper_url', 'text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'URL.text_checked'
        db.add_column(u'issue_mapper_url', 'text_checked',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'issue_mapper_url', 'text')

        # Deleting field 'URL.text_checked'
        db.delete_column(u'issue_mapper_url', 'text_checked')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.3183687062505526'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.4729942723882181'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.5478035372684885'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.6420793840004205'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e4cada696e5941a9931dcad40c8ff6af'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
