...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.bot'
        db.add_column(u'issue_mapper_person', 'bot',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.bot'
        db.delete_column(u'issue_mapper_person', 'bot')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.9686172271522537'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.9793914923953126'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.7453241079303919'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.6289227194441275'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d1126a5a0f3e403884b873e4bf9dfb36'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
