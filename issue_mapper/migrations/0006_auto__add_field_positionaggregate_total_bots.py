...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PositionAggregate.total_bots'
        db.add_column(u'issue_mapper_positionaggregate', 'total_bots',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PositionAggregate.total_bots'
        db.delete_column(u'issue_mapper_positionaggregate', 'total_bots')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.6229675169474136'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.19189785401425352'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.6909924230443034'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.31390342815342087'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3de5b2b166d747c0ae6de49592ffa19e'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
