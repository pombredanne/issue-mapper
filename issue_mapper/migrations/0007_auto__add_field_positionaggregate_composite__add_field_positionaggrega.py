...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PositionAggregate.composite'
        db.add_column(u'issue_mapper_positionaggregate', 'composite',
                      self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PositionAggregate.polarity_estimate'
        db.add_column(u'issue_mapper_positionaggregate', 'polarity_estimate',
                      self.gf('django.db.models.fields.FloatField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PositionAggregate.polarity'
        db.add_column(u'issue_mapper_positionaggregate', 'polarity',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PositionAggregate.composite'
        db.delete_column(u'issue_mapper_positionaggregate', 'composite')

        # Deleting field 'PositionAggregate.polarity_estimate'
        db.delete_column(u'issue_mapper_positionaggregate', 'polarity_estimate')

        # Deleting field 'PositionAggregate.polarity'
        db.delete_column(u'issue_mapper_positionaggregate', 'polarity')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.5918948894649791'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.4981809669404821'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.9275549221225131'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.8905044937872287'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'81af1ea7e0a442c48a852f41642100a6'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.positionaggregate': {
            ...
            'composite': ('django.db.models.fields.FloatField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        u'issue_mapper.url': {
            ...
            'text_checked': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
