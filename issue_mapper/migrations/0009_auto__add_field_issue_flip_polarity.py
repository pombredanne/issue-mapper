...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.flip_polarity'
        db.add_column(u'issue_mapper_issue', 'flip_polarity',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.flip_polarity'
        db.delete_column(u'issue_mapper_issue', 'flip_polarity')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.5657259907440263'}),
        ...
        'issue_mapper.issue': {
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'flip_polarity': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.10312874316311427'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.05118852127772422'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.7339594247912825'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c510aee35ac24e0294958bf722f93b78'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
