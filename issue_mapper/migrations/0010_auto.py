...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Issue', fields ['flip_polarity']
        db.create_index(u'issue_mapper_issue', ['flip_polarity'])

        # Adding index on 'Issue', fields ['needs_review']
        db.create_index(u'issue_mapper_issue', ['needs_review'])


    def backwards(self, orm):
        # Removing index on 'Issue', fields ['needs_review']
        db.delete_index(u'issue_mapper_issue', ['needs_review'])

        # Removing index on 'Issue', fields ['flip_polarity']
        db.delete_index(u'issue_mapper_issue', ['flip_polarity'])
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.7775655382247156'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.09757155169058218'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.6612992488164428'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.1885249926219682'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b9c3e845c1d34cf2aa554d0624337874'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
