...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'URL.og_image_thumbnail'
        db.add_column(u'issue_mapper_url', 'og_image_thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'URL.og_image_checked'
        db.add_column(u'issue_mapper_url', 'og_image_checked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'URL.og_image_thumbnail'
        db.delete_column(u'issue_mapper_url', 'og_image_thumbnail')

        # Deleting field 'URL.og_image_checked'
        db.delete_column(u'issue_mapper_url', 'og_image_checked')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.7528096651305405'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.4471421922640467'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.016978287695150307'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.561913783845344'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9f3bd152762e4e3b95473f0e5389c66f'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        u'issue_mapper.url': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'og_image_checked': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
