...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'URL', fields ['title_checked']
        db.create_index(u'issue_mapper_url', ['title_checked'])

        # Adding index on 'URL', fields ['text_checked']
        db.create_index(u'issue_mapper_url', ['text_checked'])

        # Adding index on 'URL', fields ['og_image_checked']
        db.create_index(u'issue_mapper_url', ['og_image_checked'])


    def backwards(self, orm):
        # Removing index on 'URL', fields ['og_image_checked']
        db.delete_index(u'issue_mapper_url', ['og_image_checked'])

        # Removing index on 'URL', fields ['text_checked']
        db.delete_index(u'issue_mapper_url', ['text_checked'])

        # Removing index on 'URL', fields ['title_checked']
        db.delete_index(u'issue_mapper_url', ['title_checked'])
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.614398515248599'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.6862001520604655'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.47074209936380484'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.9511875109342486'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'34cc6240859e4f04a95c9f3f68ec8930'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
