...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'URLVote'
        db.create_table(u'issue_mapper_urlvote', (
            ...
            ('voter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='url_votes', to=orm['issue_mapper.Person'])),
            ('url', self.gf('django.db.models.fields.related.ForeignKey')(related_name='votes', to=orm['issue_mapper.URL'])),
        ))
        db.send_create_signal('issue_mapper', ['URLVote'])

        # Adding unique constraint on 'URLVote', fields ['url', 'voter']
        db.create_unique(u'issue_mapper_urlvote', ['url_id', 'voter_id'])

        # Adding field 'Person.url_karma'
        db.add_column(u'issue_mapper_person', 'url_karma',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'URLVote', fields ['url', 'voter']
        db.delete_unique(u'issue_mapper_urlvote', ['url_id', 'voter_id'])

        # Deleting model 'URLVote'
        db.delete_table(u'issue_mapper_urlvote')

        # Deleting field 'Person.url_karma'
        db.delete_column(u'issue_mapper_person', 'url_karma')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.5081188802153104'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.877848031098584'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.11561397044406185'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.2897051248298673'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0a100e13f3a545b3ad6428d9dae170ca'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.urlvote': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True', 'null': 'True', 'db_index': 'True'}),
            'url': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'votes'", 'to': u"orm['issue_mapper.URL']"}),
            'vote': ('django.db.models.fields.IntegerField', [], {}),
