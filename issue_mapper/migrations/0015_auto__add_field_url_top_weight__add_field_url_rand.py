...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'URL.top_weight'
        db.add_column(u'issue_mapper_url', 'top_weight',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'URL.rand'
        db.add_column(u'issue_mapper_url', 'rand',
                      self.gf('django.db.models.fields.FloatField')(default=0.8278440735640856),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'URL.top_weight'
        db.delete_column(u'issue_mapper_url', 'top_weight')

        # Deleting field 'URL.rand'
        db.delete_column(u'issue_mapper_url', 'rand')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.9745732249155545'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.06779062850333217'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.872890649028987'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.09809838913874624'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0abf14cb422a412eaa86c78e9ba7cc05'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.4750733237853718'}),
