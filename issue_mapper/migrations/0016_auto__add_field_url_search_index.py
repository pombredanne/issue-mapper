...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'URL.search_index'
        db.add_column(u'issue_mapper_url', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'URL.search_index'
        db.delete_column(u'issue_mapper_url', 'search_index')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.6517602877231133'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.28293803178764987'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.7392756387415405'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.8675057444937873'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'47e9ba25effc4e44a2abccf3a553f77e'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.30493768189886283'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
