...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        import copy
        Link = orm['issue_mapper.Link']
        q = Link.objects.filter(person__isnull=False, issue__isnull=False)
        total = q.count()
        i = 0
        for link in q.iterator():
            i += 1
            print '%i of %i' % (i, total)
            ponly = Link.objects.filter(person=link.person, issue__isnull=True)
            if not ponly.count():
            ...
            ionly = Link.objects.filter(person__isnull=True, issue=link.issue)
            if not ionly.count():
                new_link = copy.deepcopy(link)
                new_link.id = None
                new_link.person = None
                new_link.save()
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.4858670083458605'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.4481290338258158'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.3663628887516892'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.02565265276941542'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8c6bddbb202e4d69b1dbbc0e84333bd4'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.9595344930399444'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
