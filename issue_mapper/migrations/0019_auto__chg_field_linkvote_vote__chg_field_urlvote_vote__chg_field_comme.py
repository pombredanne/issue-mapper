...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LinkVote.vote'
        db.alter_column(u'issue_mapper_linkvote', 'vote', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'URLVote.vote'
        db.alter_column(u'issue_mapper_urlvote', 'vote', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CommentVote.vote'
        db.alter_column(u'issue_mapper_commentvote', 'vote', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'LinkVote.vote'
        raise RuntimeError("Cannot reverse this migration. 'LinkVote.vote' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'URLVote.vote'
        raise RuntimeError("Cannot reverse this migration. 'URLVote.vote' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CommentVote.vote'
        raise RuntimeError("Cannot reverse this migration. 'CommentVote.vote' and its values cannot be restored.")
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.4319120110449821'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.21358069760166565'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.7793758177199972'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.8961788727530717'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6145dafe80bf43dfaf14949e389f1444'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.5066557063831817'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
