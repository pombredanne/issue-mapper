...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Quote'
        db.create_table(u'issue_mapper_quote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quotes', to=orm['issue_mapper.Person'])),
            ('url', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quotes', to=orm['issue_mapper.URL'])),
            ('said_date', self.gf('django.db.models.fields.DateField')()),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('issue_mapper', ['Quote'])

        # Adding unique constraint on 'Quote', fields ['person', 'url']
        db.create_unique(u'issue_mapper_quote', ['person_id', 'url_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Quote', fields ['person', 'url']
        db.delete_unique(u'issue_mapper_quote', ['person_id', 'url_id'])

        # Deleting model 'Quote'
        db.delete_table(u'issue_mapper_quote')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.11236969959998877'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.4056408041679682'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.2851354487394987'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.1724644917293081'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0c0ee8ac8fa24ea2926fcefc8fd9548b'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.quote': {
            'Meta': {'unique_together': "(('person', 'url'),)", 'object_name': 'Quote'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.7805750606908992'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
