...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Priviledge.single_quote_person'
        db.add_column(u'issue_mapper_priviledge', 'single_quote_person',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Priviledge.single_quote_person'
        db.delete_column(u'issue_mapper_priviledge', 'single_quote_person')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.6915087323004414'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.8785959850437076'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.338623056469636'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.6904208943224102'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f850f1e9a211401f993d79172122f617'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.558072484453813'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
