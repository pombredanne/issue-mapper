...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Quote', fields ['url', 'person']
        db.delete_unique(u'issue_mapper_quote', ['url_id', 'person_id'])

        # Adding unique constraint on 'Quote', fields ['url', 'person', 'text', 'said_date']
        db.create_unique(u'issue_mapper_quote', ['url_id', 'person_id', 'text', 'said_date'])


    def backwards(self, orm):
        # Removing unique constraint on 'Quote', fields ['url', 'person', 'text', 'said_date']
        db.delete_unique(u'issue_mapper_quote', ['url_id', 'person_id', 'text', 'said_date'])

        # Adding unique constraint on 'Quote', fields ['url', 'person']
        db.create_unique(u'issue_mapper_quote', ['url_id', 'person_id'])
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.9812049036410536'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.9156623610863286'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.928340025489737'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.9838656141864014'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e8320b9d95ae41a6bde8ed413baa03e3'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.quote': {
            'Meta': {'unique_together': "(('person', 'url', 'said_date', 'text'),)", 'object_name': 'Quote'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.7834603827245317'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
