...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'County'
        db.create_table(u'issue_mapper_county', (
            ...
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issue_mapper.State'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('issue_mapper', ['County'])

        # Adding unique constraint on 'County', fields ['state', 'name']
        db.create_unique(u'issue_mapper_county', ['state_id', 'name'])

        # Adding model 'Context'
        db.create_table(u'issue_mapper_context', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, db_index=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True, auto_now_add=True, null=True, db_index=True)),
            ('deleted', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
            ...
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issue_mapper.State'], null=True, blank=True)),
            ('county', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issue_mapper.County'], null=True, blank=True)),
        ))
        db.send_create_signal('issue_mapper', ['Context'])

        # Adding unique constraint on 'Context', fields ['name', 'country', 'state', 'county']
        db.create_unique(u'issue_mapper_context', ['name', 'country_id', 'state_id', 'county_id'])

        # Adding model 'State'
        db.create_table(u'issue_mapper_state', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, db_index=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True, auto_now_add=True, null=True, db_index=True)),
            ('deleted', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
        ...
        db.send_create_signal('issue_mapper', ['State'])

        # Adding unique constraint on 'State', fields ['country', 'state']
        db.create_unique(u'issue_mapper_state', ['country_id', 'state'])


    def backwards(self, orm):
        # Removing unique constraint on 'State', fields ['country', 'state']
        db.delete_unique(u'issue_mapper_state', ['country_id', 'state'])

        # Removing unique constraint on 'Context', fields ['name', 'country', 'state', 'county']
        db.delete_unique(u'issue_mapper_context', ['name', 'country_id', 'state_id', 'county_id'])

        # Removing unique constraint on 'County', fields ['state', 'name']
        db.delete_unique(u'issue_mapper_county', ['state_id', 'name'])

        # Deleting model 'County'
        db.delete_table(u'issue_mapper_county')

        # Deleting model 'Context'
        db.delete_table(u'issue_mapper_context')

        # Deleting model 'State'
        db.delete_table(u'issue_mapper_state')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.6214863316521443'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.8826687277921322'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.6326841477406623'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.42178736269642236'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'654db596567f4bc3be17cf563134fe25'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.14854506557400504'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
