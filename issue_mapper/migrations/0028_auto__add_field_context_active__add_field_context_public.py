...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Context.active'
        db.add_column(u'issue_mapper_context', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Context.public'
        db.add_column(u'issue_mapper_context', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Context.active'
        db.delete_column(u'issue_mapper_context', 'active')

        # Deleting field 'Context.public'
        db.delete_column(u'issue_mapper_context', 'public')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.05968889200533378'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.05515651474718131'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.9912626055873499'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.3317597375821132'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2e4e218240cb47c8bb4419d4193526cd'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.179411556712594'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
