...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'URLContext'
        db.create_table(u'issue_mapper_urlcontext', (
            ...
            ('context', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issue_mapper.Context'])),
            ...
            ('absolute_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('weight', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('url', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issue_mapper.URL'])),
        ))
        db.send_create_signal('issue_mapper', ['URLContext'])

        # Adding unique constraint on 'URLContext', fields ['url', 'context']
        db.create_unique(u'issue_mapper_urlcontext', ['url_id', 'context_id'])

        # Adding model 'URLContextVote'
        db.create_table(u'issue_mapper_urlcontextvote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, db_index=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True, auto_now_add=True, null=True, db_index=True)),
            ('deleted', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
            ('vote', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('voter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='url_context_votes', to=orm['issue_mapper.Person'])),
            ('url_context', self.gf('django.db.models.fields.related.ForeignKey')(related_name='votes', to=orm['issue_mapper.URLContext'])),
        ))
        db.send_create_signal('issue_mapper', ['URLContextVote'])

        # Adding unique constraint on 'URLContextVote', fields ['url_context', 'voter']
        db.create_unique(u'issue_mapper_urlcontextvote', ['url_context_id', 'voter_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'URLContextVote', fields ['url_context', 'voter']
        db.delete_unique(u'issue_mapper_urlcontextvote', ['url_context_id', 'voter_id'])

        # Removing unique constraint on 'URLContext', fields ['url', 'context']
        db.delete_unique(u'issue_mapper_urlcontext', ['url_id', 'context_id'])

        # Deleting model 'URLContext'
        db.delete_table(u'issue_mapper_urlcontext')

        # Deleting model 'URLContextVote'
        db.delete_table(u'issue_mapper_urlcontextvote')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.5297783386398844'}),
        ...
        'issue_mapper.context': {
            'Meta': {'ordering': "('country', 'state', 'county', 'name')", 'unique_together': "(('name', 'country', 'state', 'county'),)", 'object_name': 'Context'},
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.3955761674890603'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.023646272564633253'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.5123905666950023'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'682003c3dfbf4893a0b08c92e613b970'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.5642262723377045'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.urlcontext': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True', 'null': 'True', 'db_index': 'True'}),
            'url': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['issue_mapper.URL']"}),
            'votes_down': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'votes_up': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'weight': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'issue_mapper.urlcontextvote': {
            'Meta': {'unique_together': "(('url_context', 'voter'),)", 'object_name': 'URLContextVote'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True', 'null': 'True', 'db_index': 'True'}),
