...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Context.description'
        db.add_column(u'issue_mapper_context', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=700, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Context.description'
        db.delete_column(u'issue_mapper_context', 'description')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.8184106004484357'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.9093659113317356'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.921455840450339'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.15786379702093878'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e31752d8cd4d4a4d9ab05f7e29eaffeb'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.2710713399509316'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
