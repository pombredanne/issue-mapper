...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'URLContext.creator'
        db.add_column(u'issue_mapper_urlcontext', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='url_contexts_created', null=True, to=orm['issue_mapper.Person']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'URLContext.creator'
        db.delete_column(u'issue_mapper_urlcontext', 'creator_id')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.06464939716001128'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.8747071939090809'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.3300884514031366'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.21450884892316457'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'64eeb2be9e18426da9f372ae181762d2'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.49325484967923305'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
