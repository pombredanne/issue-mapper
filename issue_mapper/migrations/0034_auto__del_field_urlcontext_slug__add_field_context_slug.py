...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'URLContext.slug'
        db.delete_column(u'issue_mapper_urlcontext', 'slug')

        # Adding field 'Context.slug'
        db.add_column(u'issue_mapper_context', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=700, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'URLContext.slug'
        db.add_column(u'issue_mapper_urlcontext', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Context.slug'
        db.delete_column(u'issue_mapper_context', 'slug')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.36292997110542724'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.548695500110375'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.48080685712088644'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.4801890449015461'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9a78f8a858c94a1191cb1fd47d05f999'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.7912087661071692'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
