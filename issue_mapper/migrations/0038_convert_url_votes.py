...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        URL = orm['issue_mapper.URL']
        Issue = orm['issue_mapper.Issue']
        Context = orm['issue_mapper.Context']
        URLContext = orm['issue_mapper.URLContext']
        URLContextVote = orm['issue_mapper.URLContextVote']
        
        context = Context.objects.get(id=1)
        
        for issue in Issue.objects.all():
            issue.contexts.add(context)
            issue.save()
            
        q = URL.objects.all().exclude(id__in=URLContext.objects.all().values_list('url__id', flat=True)).order_by('-created')
        total = q.count()
        i = 0
        for url in q.iterator():
            i += 1
            if not i or not i % 100:
                print '%i of %i' % (i, total)
            uc, _ = URLContext.objects.get_or_create(
                url=url, context=context)
            for vote in url.votes.all():
                ucv, _ = URLContextVote.objects.get_or_create(
                    voter=vote.voter, url_context=uc, vote=vote.vote)
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.47030393404533033'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.8484970737885227'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.39206679998282334'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.6778282124624203'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8f38a6492c3b497c96c4a56532e27d96'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.5990871727466494'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.urlcontext': {
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.575312312471476'}),
            'top_weight': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True', 'null': 'True', 'db_index': 'True'}),
