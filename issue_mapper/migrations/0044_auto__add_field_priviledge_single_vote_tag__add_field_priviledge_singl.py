...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Priviledge.single_vote_tag'
        db.add_column(u'issue_mapper_priviledge', 'single_vote_tag',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=5),
                      keep_default=False)

        # Adding field 'Priviledge.single_submit_quote'
        db.add_column(u'issue_mapper_priviledge', 'single_submit_quote',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=5),
                      keep_default=False)

        # Adding field 'Priviledge.single_vote_quote'
        db.add_column(u'issue_mapper_priviledge', 'single_vote_quote',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=5),
                      keep_default=False)

        # Adding field 'Priviledge.single_flag_quote'
        db.add_column(u'issue_mapper_priviledge', 'single_flag_quote',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Priviledge.single_vote_tag'
        db.delete_column(u'issue_mapper_priviledge', 'single_vote_tag')

        # Deleting field 'Priviledge.single_submit_quote'
        db.delete_column(u'issue_mapper_priviledge', 'single_submit_quote')

        # Deleting field 'Priviledge.single_vote_quote'
        db.delete_column(u'issue_mapper_priviledge', 'single_vote_quote')

        # Deleting field 'Priviledge.single_flag_quote'
        db.delete_column(u'issue_mapper_priviledge', 'single_flag_quote')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.32517542938342225'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.7371943051167624'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.2694879940027113'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.43261758762280733'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bb9e5ce6c9ed4eb895c66473982f994f'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.08661264642826161'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.urlcontext': {
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.9249419220185795'}),
            'top_weight': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True', 'null': 'True', 'db_index': 'True'}),
