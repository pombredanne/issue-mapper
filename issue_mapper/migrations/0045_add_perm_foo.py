...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        from issue_mapper import models as im
        
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(
            model='person', app_label='issue_mapper') # model must be lowercase!
        for codename, name in im.Quote._meta.permissions:
            print codename, len(codename), name, len(name)
            assert len(name) <= 50, 'Name for %s is too long, must be <= 50.' % (codename,)
            perm, created = orm['auth.permission'].objects.get_or_create(
                content_type=ct, codename=codename, defaults=dict(name=name))
        
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(
            model='quote', app_label='issue_mapper') # model must be lowercase!
        for codename, name in im.Quote._meta.permissions:
            print codename, len(codename), name, len(name)
            assert len(name) <= 50, 'Name for %s is too long, must be <= 50.' % (codename,)
            perm, created = orm['auth.permission'].objects.get_or_create(
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.9415140102582645'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.7000779987770258'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.9486657250094271'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.3587108213368614'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b93fc57a2bc64c4a8370754b1c3e387a'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.5051148674657376'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.urlcontext': {
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.784852007145982'}),
            'top_weight': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True', 'null': 'True', 'db_index': 'True'}),
    ...
    complete_apps = ['contenttypes', 'auth', 'issue_mapper']
    symmetrical = True
