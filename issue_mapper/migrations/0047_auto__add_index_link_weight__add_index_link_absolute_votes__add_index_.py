...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Link', fields ['weight']
        db.create_index(u'issue_mapper_link', ['weight'])

        # Adding index on 'Link', fields ['absolute_votes']
        db.create_index(u'issue_mapper_link', ['absolute_votes'])

        # Adding index on 'Link', fields ['votes_down']
        db.create_index(u'issue_mapper_link', ['votes_down'])

        # Adding index on 'Link', fields ['votes_up']
        db.create_index(u'issue_mapper_link', ['votes_up'])


    def backwards(self, orm):
        # Removing index on 'Link', fields ['votes_up']
        db.delete_index(u'issue_mapper_link', ['votes_up'])

        # Removing index on 'Link', fields ['votes_down']
        db.delete_index(u'issue_mapper_link', ['votes_down'])

        # Removing index on 'Link', fields ['absolute_votes']
        db.delete_index(u'issue_mapper_link', ['absolute_votes'])

        # Removing index on 'Link', fields ['weight']
        db.delete_index(u'issue_mapper_link', ['weight'])
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.985132642625224'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.8805147584166513'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.48468817261324715'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.8092480455074365'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bd83b28ef0f34eb48c7ef865511eac3d'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.5392838581611509'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.urlcontext': {
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.18420948487204758'}),
            'top_weight': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True', 'null': 'True', 'db_index': 'True'}),
