...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.context'
        db.add_column(u'issue_mapper_election', 'context',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issue_mapper.Context'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Election.keywords'
        db.add_column(u'issue_mapper_election', 'keywords',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Election.generate_keywords'
        db.add_column(u'issue_mapper_election', 'generate_keywords',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Election.search_index'
        db.add_column(u'issue_mapper_election', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.context'
        db.delete_column(u'issue_mapper_election', 'context_id')

        # Deleting field 'Election.keywords'
        db.delete_column(u'issue_mapper_election', 'keywords')

        # Deleting field 'Election.generate_keywords'
        db.delete_column(u'issue_mapper_election', 'generate_keywords')

        # Deleting field 'Election.search_index'
        db.delete_column(u'issue_mapper_election', 'search_index')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.8233751522099733'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.35744554560228625'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.8842871324533844'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.8522288611963901'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f08862c7363c4c218b168315783b2a4d'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.3085880970321059'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.urlcontext': {
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.7361367567211476'}),
            'top_weight': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True', 'null': 'True', 'db_index': 'True'}),
