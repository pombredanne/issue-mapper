...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TripleVote'
        db.create_table(u'issue_mapper_triplevote', (
            ...
            ('triple', self.gf('django.db.models.fields.related.ForeignKey')(related_name='votes', to=orm['sense.Triple'])),
            ('weight', self.gf('django.db.models.fields.FloatField')()),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='votes', to=orm['issue_mapper.Person'])),
        ))
        db.send_create_signal(u'issue_mapper', ['TripleVote'])


    def backwards(self, orm):
        # Deleting model 'TripleVote'
        db.delete_table(u'issue_mapper_triplevote')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.7035703311892019'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.07710873098637894'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.4712267391888755'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.584482742517638'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9ed0e5fe31564c69bd3e44cb6002a346'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.10878593310023188'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.urlcontext': {
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.43497078130618305'}),
            'top_weight': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True', 'null': 'True', 'db_index': 'True'}),
