...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SenseLink'
        db.create_table(u'issue_mapper_senselink', (
            ...
            ('sense', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sense.Sense'], unique=True)),
            ('issue', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['issue_mapper.Issue'], unique=True, null=True, blank=True)),
            ('link', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['issue_mapper.Link'], unique=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'issue_mapper', ['SenseLink'])

        # Adding unique constraint on 'SenseLink', fields ['sense', 'issue']
        db.create_unique(u'issue_mapper_senselink', ['sense_id', 'issue_id'])

        # Adding unique constraint on 'SenseLink', fields ['sense', 'link']
        db.create_unique(u'issue_mapper_senselink', ['sense_id', 'link_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SenseLink', fields ['sense', 'link']
        db.delete_unique(u'issue_mapper_senselink', ['sense_id', 'link_id'])

        # Removing unique constraint on 'SenseLink', fields ['sense', 'issue']
        db.delete_unique(u'issue_mapper_senselink', ['sense_id', 'issue_id'])

        # Deleting model 'SenseLink'
        db.delete_table(u'issue_mapper_senselink')
    ...
    models = {
        ...
        'issue_mapper.comment': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.021907837885884573'}),
        ...
        'issue_mapper.issue': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.12711533003935682'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.link': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.5472232238411334'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.person': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.41813684850843036'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'59e5dd30058b4f34919522dee50d3f15'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
        ...
        u'issue_mapper.senselink': {
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['issue_mapper.Issue']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'link': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['issue_mapper.Link']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'issue_mapper.url': {
            ...
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.39190523257188314'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
        ...
        'issue_mapper.urlcontext': {
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rand': ('django.db.models.fields.FloatField', [], {'default': '0.5810455979446548'}),
            'top_weight': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True', 'null': 'True', 'db_index': 'True'}),
