...
urlpatterns = patterns('',
    ...
    url(r'^'+settings.IM_URL_PREFIX+'(?P<object_type>issue)/(?P<object_id>[0-9]+)/flag/$',
        ...
        name='flag', kwargs=dict(object_type='issue')),
    ...
    url(r'^'+settings.IM_URL_PREFIX+'(?P<object_type>person)/(?P<object_id>[0-9]+)/flag/$',
        'issue_mapper.views.flag',
        name='flag',
        kwargs=dict(object_type='person')),
    ...
    url(r'^'+settings.IM_URL_PREFIX+'(?P<object_type>person)/(?P<object_id>[0-9]+)/flag/confirmed/$',
        'issue_mapper.views.flag',
        dict(confirmed=True, object_type='person'),
        name='flag_confirmed'),
    ...
    url(r'^'+settings.IM_URL_PREFIX+'person/(?P<person_slug>[a-z0-9\.\-]+)/(?P<type>link)/$',
        ...
        name='person',
        kwargs=dict(type=c.LINK)),
    url(r'^'+settings.IM_URL_PREFIX+'person/(?P<person_slug>[a-z0-9\.\-]+)/(?P<type>comment)/$',
        views.CommentListView.as_view(),
        name='person',
        kwargs=dict(type=c.COMMENT)),
    url(r'^'+settings.IM_URL_PREFIX+'person/(?P<person_slug>[a-z0-9\.\-]+)/(?P<type>quote)/$',
        views.QuoteListView.as_view(),
        name='person',
        kwargs=dict(type=c.QUOTE)),
    ...
    url(r'^'+settings.IM_URL_PREFIX+'quote/$',
        views.QuoteListView.as_view(),
        name='quote_list'),
    ...
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/?$',
        views.RationaleEditView.as_view(),
        name='rationale_edit'),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/triple/get/?$',
        views.RationaleEditView.as_view(),
        name='get_rationale_triple',
        kwargs=dict(subtype='triple', action='get')),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/triple/(?P<triple_id>[0-9]+)/(?P<part>[a-z]+)/edit/?$',
        views.RationaleEditView.as_view(),
        name='edit_rationale_triple',
        kwargs=dict(subtype='triple', action='edit')),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/triple/(?P<triple_id>[0-9]+)/(?P<part>[a-z]+)/switch/?$',
        views.RationaleEditView.as_view(),
        name='switch_rationale_triple',
        kwargs=dict(subtype='triple', action='switch')),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/triple/delete/?$',
        views.RationaleEditView.as_view(),
        name='delete_rationale_triple',
        kwargs=dict(action='delete', subtype='triple')),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/triple/create/?$',
        views.RationaleEditView.as_view(),
        name='create_rationale_triple',
        kwargs=dict(action='create', subtype='triple')),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/inference/create/?$',
        views.RationaleEditView.as_view(),
        name='create_rationale_inference',
        kwargs=dict(action='create', subtype='inference')),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/triple/search/?$',
        views.RationaleEditView.as_view(),
        name='search_rationale_triple',
        kwargs=dict(action='search', subtype='triple')),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/triple/(?P<triple_id>[0-9]+)/goal/?$',
        views.RationaleEditView.as_view(),
        name='set_rationale_goal',
        kwargs=dict(action='goal', subtype='triple')),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/sense/search/?$',
        views.RationaleEditView.as_view(),
        name='search_rationale_sense',
        kwargs=dict(action='search', subtype='sense')),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/search/?$',
        views.RationaleEditView.as_view(),
        name='search_rationale',
        kwargs=dict(action='search', subtype='triple_sense')),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/sense/(?P<sense_id>[0-9]+)/edit/?$',
        views.RationaleEditView.as_view(),
        name='edit_rationale_predicate',
        kwargs=dict(action='edit_predicate', subtype='triple')),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/rules/search/?$',
        views.RationaleEditView.as_view(),
        name='search_rationale_rules',
        kwargs=dict(action='search', subtype='rules')),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/settings/save/?$',
        views.RationaleEditView.as_view(),
        name='save_rationale_settings',
        kwargs=dict(action='save', subtype='settings')),
    ...
    url(r'^'+settings.IM_URL_PREFIX+'user/(?P<username>[^/]+)/privileges/$',
