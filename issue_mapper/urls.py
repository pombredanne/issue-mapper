...
urlpatterns = patterns('',
    ...
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/(?P<subtype>triple)/(?P<action>get)/?$',
        views.RationaleEditView.as_view(),
        name='get_rationale_triple'),
                       
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/(?P<subtype>triple)/(?P<triple_id>[0-9]+)/(?P<part>[a-z]+)/(?P<action>edit)/?$',
        views.RationaleEditView.as_view(),
        name='edit_rationale_triple'),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/(?P<subtype>triple)/(?P<triple_id>[0-9]+)/(?P<part>[a-z]+)/(?P<action>switch)/?$',
        views.RationaleEditView.as_view(),
        name='switch_rationale_triple'),
                       
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/(?P<subtype>triple)/(?P<action>delete)/?$',
        views.RationaleEditView.as_view(),
        name='delete_rationale_triple'),
                       
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/(?P<subtype>triple)/(?P<action>create)/?$',
        views.RationaleEditView.as_view(),
        name='create_rationale_triple'),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/(?P<subtype>triple)/(?P<action>search)/?$',
        views.RationaleEditView.as_view(),
        name='search_rationale_triple'),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/(?P<subtype>sense)/(?P<action>search)/?$',
        views.RationaleEditView.as_view(),
        name='search_rationale_sense'),
    url(r'^'+settings.IM_URL_PREFIX+'rationale/(?P<rationale_id>[0-9]+)/search/?$',
        views.RationaleEditView.as_view(),
        name='search_rationale',
        kwargs=dict(action='search')),
